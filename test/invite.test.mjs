...
import { sanitizeText, validateInvite, formatSlot, buildMailto, DURATIONS } from '../public/js/lib/invite.mjs';
...
test('caps and cleans the note instead of failing on it', () => {
  ...
  assert.ok(!res.value.note.includes('<'), 'angle brackets survived');
});
